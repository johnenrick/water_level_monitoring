...
<script>
    ...
    var WebMapComponent = function(containerSelector, config){
        ...
        var pointers = L.Icon.extend({
            options:{
                shadowUrl:asset_url('img/marker-shadow.png'),
        ...
        webMapComponent.icon = {
            LGU : new pointers({iconUrl:asset_url('img/lgu.png')}),
            garbage : new pointers({iconUrl:asset_url('img/garbage.png')}),
            dumping_area : new pointers({iconUrl:asset_url('img/dumpingarea.png')}),
            report : new pointers({iconUrl:asset_url('img/report.png')}),
            service : new pointers({iconUrl:asset_url('img/services.png')}),
            user_location : new pointers({iconUrl:asset_url('img/userlocation.png')})
        };
